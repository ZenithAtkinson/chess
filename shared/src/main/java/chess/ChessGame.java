...
public class ChessGame {
    ...
    private void ActuallyDoMove(ChessMove move, ChessBoard tempboard) throws InvalidMoveException {
        ChessPiece piece = tempboard.getPiece(move.getStartPosition());
        if (piece == null) throw new InvalidMoveException("No starting piece");
